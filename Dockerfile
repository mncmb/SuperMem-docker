...
RUN git clone https://github.com/CrowdStrike/SuperMem.git /app && cd /app && pip3 install -r requirements.txt && chmod +x ./winSuperMem.py && echo "python3 /app/winSuperMem.py" > /usr/bin/winSuperMem && chmod +x /usb/bin/winSuperMem && mkdir /work
